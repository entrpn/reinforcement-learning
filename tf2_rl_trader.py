...
class MultiStockEnv:
    ...
    def _trade(self, action):
        ...
        if sell_index:
            # NOTE: to simplify the problem, when we sell, we will sell ALL shares of a stock
            for i in sell_index:
...
class DQNAgent(object):
    ...
    def replay(self, batch_size=32):
        ...
        # We can acomplish this by setting the target to be equal to
...
if __name__ == '__main__':
    ...
    #play the game num_episode times
